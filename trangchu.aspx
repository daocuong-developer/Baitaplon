<%@ Page Title="" Language="C#" MasterPageFile="~/formgiaodien.Master" AutoEventWireup="true" CodeBehind="trangchu.aspx.cs" Inherits="Baitaplon.trangchu" %>
    ...
    <div class="container">
        <div class="product-grid">
            <asp:DataList ID="DataList1" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" OnItemCommand="DataList1_ItemCommand" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">
                <ItemTemplate>
                    <div class="card">
                        <a href='<%# "mp.aspx?MaSanPham=" + Eval("MaSanPham") %>'>
                        <!-- Product Image -->
                        <asp:Image ID="Image1" runat="server" ImageUrl='<%# "~/img/"+Eval("HinhAnh") %>' CssClass="img-fluid" />
                        </a>
                        <!-- Button Hidden by Default -->
                        <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" OnClick="Button1_Click" Text="Thêm Vào Giỏ Hàng" CommandArgument='<%# Eval("MaSanPham") %>' />
